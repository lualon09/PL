...
(func $main
 ...
 ;;generating code for exp ebinEQUAL(AVar(x),(INT:3))
 ...
 i32.eq
 if
 ;;generating code for assignation assign:AVar(x)=(INT:5)
 i32.const 0
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 i32.const 5
 i32.store
 ;;end generating code for assignation assign:AVar(x)=(INT:5)
 end
 ...
 ;;end generating code for access
 call $show
 ;;generating code for declaration dec:ok(type:BOOL)=(BOOL:False)
 i32.const 4
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 ...
 ;;end generating code for access
 if
 ;;generating code for assignation assign:AVar(x)=(INT:7)
 i32.const 0
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 i32.const 7
 i32.store
 ;;end generating code for assignation assign:AVar(x)=(INT:7)
 ...
 ;;generating code for declaration dec:y(type:INT)=(INT:5)
 i32.const 8
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 ...
 i32.store
 ;;end generating code for declaration
 ;;generating code for declaration dec:z(type:INT)=(INT:4)
 i32.const 12
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 ...
 i32.eqz
 if
 ;;generating code for assignation assign:AVar(x)=(INT:2)
 i32.const 0
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 i32.const 2
 i32.store
 ;;end generating code for assignation assign:AVar(x)=(INT:2)
 end
 ;; generating code for IShow
 ;;generating code for access
 i32.const 0

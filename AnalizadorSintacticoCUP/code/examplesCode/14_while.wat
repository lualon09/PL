...
(func $main
 ...
 ;;generating code for declaration dec:maximo(type:INT)=(INT:10)
 i32.const 4
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 ...
 i32.store
 ;;end generating code for declaration
 ;;generating code for declaration dec:siempre(type:BOOL)=(BOOL:True)
 i32.const 8
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 ...
 block
 loop
 ;;generating code for exp ebinAND(LESS(AVar(x),(INT:10)),AVar(siempre))
 ;;generating code for exp ebinLESS(AVar(x),(INT:10))
 ;;generating code for access
 i32.const 0
 local.get $localsStart
 i32.add

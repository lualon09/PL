...
(func $preMain 
 ...
 ;; generating code of function factorial
(func $factorial
 ...
 i32.add
 local.set $localsStart
 ;;generating code for declaration dec:fact(type:INT)=(INT:1)
 i32.const 4
 ...
 ;;generating code for declaration dec:i(type:INT)=(INT:1)
 i32.const 8
 local.get $localsStart
 i32.add
 ;;generating code for EConst
 ...
 block
 loop
 ;;generating code for exp ebinLEQ(AVar(i),AVar(n))
 ...
 i32.eqz
 br_if 1
 ;;generating code for assignation assign:AVar(fact)=MUL(AVar(i),AVar(fact))
 i32.const 4
 local.get $localsStart
 i32.add
 ;;generating code for exp ebinMUL(AVar(i),AVar(fact))
 ;;generating code for access
 i32.const 8
 local.get $localsStart
 i32.add
 ...
 i32.mul
 i32.store
 ;;end generating code for assignation assign:AVar(fact)=MUL(AVar(i),AVar(fact))

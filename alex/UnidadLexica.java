...
public class UnidadLexica extends Symbol {
	...
	if (lexema() == null) {
        ...
        if(clase() == 15){
            return "[clase:"+"PALABRA"+",fila:"+fila()+",col:"+columna()+",lexema:"+lexema()+"]";
        }
        else if (clase() == 16){
            return "[clase:"+"PATRON"+",fila:"+fila()+",col:"+columna()+",lexema:"+lexema()+"]";
        }
        else if(clase() == 17){
            return "[clase:"+"OTRO"+",fila:"+fila()+",col:"+columna()+",lexema:"+lexema()+"]";
        }
